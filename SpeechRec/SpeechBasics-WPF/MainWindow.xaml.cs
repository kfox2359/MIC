    ...
    public partial class MainWindow : Window
    {
        ...
        private void WindowLoaded(object sender, RoutedEventArgs e)
        {
            ...
            if (null != ri)
            {
                ...
                directions.Add(new SemanticResultValue("bye", "BYE"));
                directions.Add(new SemanticResultValue("goodbye", "BYE"));
                directions.Add(new SemanticResultValue("reset", "RESET"));
                directions.Add(new SemanticResultValue("startover", "RESET"));
        ...
        private void ClearRecognitionHighlights()
        {
            ...
            {
                if (span != null && recognitionSpans!= null)
        ...
        **/
        ...
        private void SpeechRecognized(object sender, SpeechRecognizedEventArgs e)
        {
            ...
            String youSaidText = "You said:";
            String KinectSaysText = "Kinect says:";
            String speechRecConfText = "Confidence:";
